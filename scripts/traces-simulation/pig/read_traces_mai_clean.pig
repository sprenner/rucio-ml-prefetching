...
rucio_traces = LOAD '/user/rucio01/traces/traces.2018-05-*' USING rucioudfs.TracesLoader() as (
 account: chararray,
 appid: chararray,
 catStart: double,
...
store reduce_fields_final into '/user/sprenner/traces_mai_clean.csv' using PigStorage('\t');
